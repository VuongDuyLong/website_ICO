...
async function main() {
    ...
    const ico = await Ico.deploy(1000,100,'0xe1d353eFd9EfD2e77C43378258f77F0839759291', '0x7F0bCE2C0D227Cb33C9A2e41880Aa1C759dCB1C3');
    ...
    // const heroMarketplace = await MKP.deploy("0xa9824aF7395d8dE0FCf898b02Ef654A760b8Fd81", "0x7F0bCE2C0D227Cb33C9A2e41880Aa1C759dCB1C3");
